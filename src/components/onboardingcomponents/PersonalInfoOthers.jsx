        ...
        <Grid container spacing={3}>
            ...
            <Grid size={6}>
                <Controller name="cellPhone" control={control} render={({ field }) => (
                    <TextField {...field} label="Cell Phone" required disabled={isLocked} fullWidth />
                )} />
            </Grid>
            <Grid size={6}>
            ...
            <Grid size={4}>
                <Controller name="ssn" control={control} render={({ field }) => (
                    <TextField {...field} label="SSN" disabled={isLocked} fullWidth />
                )} />
            </Grid>
            <Grid size={4}>
                <Controller name="DOB" control={control} render={({ field }) => (
                    <TextField {...field} type="date" label="Date of Birth" InputLabelProps={{ shrink: true }} disabled={isLocked} fullWidth />
                )} />
            </Grid>
            <Grid size={4}>
                <Controller name="gender" control={control} render={({ field }) => (
                    <Select {...field} fullWidth disabled={isLocked} required displayEmpty>
